...
public class GameManagerTest {
    ...
    public void shouldCreateGame(){
        var gm = new GameManagerImpl(4, 30, 20);
    ...
    public void shouldNotAddPlayerIfMaxIs0(){
        var gm = new GameManagerImpl(0, 30, 20);
        var playerAdded = gm.addPlayer(new Player(1));
    ...
    void shouldMovePlayerHeadsWhenTick(){
        var gm = new GameManagerImpl(2, 30, 20);
    ...
    @Test
    void shouldReturnFalseWhenCollideWall(){
        var gm = new GameManagerImpl(2, 30, 20);
        var player1 = new Player(1);

        player1.setHead(new Point(1,4));
        player1.setHead(new Point(0,4));
        ...
        assertFalse(player1.getAlive());
    }

    @Test
    void shouldReturnFalseWhenCollideSelf(){
        var gm = new GameManagerImpl(2, 30, 20);
        var player1 = new Player(1);
    ...
    @Test
    void shouldReturnTrueWhenNoCollide(){
        var gm = new GameManagerImpl(2, 30, 20);
        var player1 = new Player(1);
